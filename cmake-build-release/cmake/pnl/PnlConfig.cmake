...
function(pnl_add_postbuild target)
	...
	if(MSVC)
		set(components libpnl.dll libblas.dll liblapack.dll libgcc_s_seh-1.dll libquadmath-0.dll libgfortran-5.dll libwinpthread-1.dll)
...
if (PNL_FOUND)
    if (MSVC)
        ...
        set(PNL_INCLUDE_DIRS ${PNL_INCLUDE_DIR} )
        set(PNL_LIBRARIES ${PNL_LIBRARY} /usr/local/src/libs/lapack-3.7.1/build-win64/lib/libblas.dll;/usr/local/src/libs/lapack-3.7.1/build-win64/lib/liblapack.dll;/usr/local/src/libs/lapack-3.7.1/build-win64/lib/libblas.dll)
    endif(MSVC)
